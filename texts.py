...
THREE_PHOTOS = """Осталось загрузить 3 актуальные фотографии вашего лица с разного ракурса (анфас и чуть сбоку) для составления вашего личного датасета.
...
ALL_PHOTO = """Вы загрузили 3 фотографии. Подтвердите загрузку"""
